...
describe("Argon2 Parameter Validation", () => {
  ...
  it("argon2d_hash with password less than minimal length throws Exception", () => {
    ...
    expect(
      argon2.argon2d_hash.bind(argon2, password, salt, keysize)
    ).toThrowError(
      "Password of length 1 does not correspond to minimal security settings."
    );
  });

  it("argon2d_hash with salt less than minimal length throws exception", () => {
  ...
  it("argon2d_hash with less than minimal size throws exception", () => {
    const password: string = "passwordpassword";
    const salt: string = "saltsaltsaltsalt"; // salt should be truely random - this here is just for testing purposes - never do this in a real application
  ...
  it("argon2d_hash with less than minimal t_cost throws exception", () => {
    const password: string = "passwordpassword";
    const salt: string = "saltsaltsaltsalt"; // salt should be truely random - this here is just for testing purposes - never do this in a real application
    ...
    const argon2: Argon2 = new Argon2();
    expect(
      argon2.argon2d_hash.bind(argon2, password, salt, keysize, parameters)
    ).toThrowError(
      `Parameter t_cost does not fulfill minimal security settings.`
    );
  });

  it("argon2d_hash with less than minimal m_cost throws exception", () => {
    const password: string = "passwordpassword";
    const salt: string = "saltsaltsaltsalt"; // salt should be truely random - this here is just for testing purposes - never do this in a real application
    const parameters: Argon2Parameters = {
  ...
  it("argon2d_hash with less than minimal parallelism throws exception", () => {
    const password: string = "passwordpassword";
    const salt: string = "saltsaltsaltsalt"; // salt should be truely random - this here is just for testing purposes - never do this in a real application
    const parameters: Argon2Parameters = {
      t_cost: argon2_min_t_cost,
  ...
  it("argon2d_hash with more than minimal t_cost calculates hash correctly", () => {
    const password: string = "passwordpassword";
    const salt: string = "saltsaltsaltsalt"; // salt should be truely random - this here is just for testing purposes - never do this in a real application
    const parameters: Argon2Parameters = {
    ...
    const keysize: number = argon2_min_size;
    const argon2: Argon2 = new Argon2();
    const actual_hash = argon2.argon2d_hash(
      password,
      salt,
      keysize,
      parameters
  ...
  it("argon2d_hash with more than minimal m_cost calculates hash correctly", () => {
    const password: string = "passwordpassword";
    const salt: string = "saltsaltsaltsalt"; // salt should be truely random - this here is just for testing purposes - never do this in a real application
    const parameters: Argon2Parameters = {
      t_cost: argon2_min_t_cost,
